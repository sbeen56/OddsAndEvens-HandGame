...
public class MediumArtIntPlayer implements ArtIntPlayer {
  ...
  public int makeMove(String winner, int round, int oddCount, int evenCount) {
    if (round < 4) {
      ...
      setStrategy(new TopStrategy()); // Set the strategy to top after the first 3 rounds
    }
  ...
  /**
   * This method gets the finger generated by the AI player.
   *
   * @return int finger generated by the AI player
   */
  @Override
  ...
  /**
   * This method gets the choice of the AI player.
   *
  ...
  /**
   * This method gets the name of the AI player.
   *
